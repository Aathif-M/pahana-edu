...
<form method="post" action="bill">
    ...
    <input class="custom-input" type="number" name="accountNumber" value="<%= (customer != null) ? customer.getAccountNumber() : "" %>" required autofocus/>

    <label>Name:</label>
    <input class="custom-input" type="text" name="name" value="<%= (customer != null) ? customer.getName() : "" %>" />

    <label>Address:</label>
    <input class="custom-input" type="text" name="address" value="<%= (customer != null) ? customer.getAddress() : "" %>" />

    <label>Telephone:</label>
    <input class="custom-input" type="number" name="telephone" value="<%= (customer != null) ? customer.getTelephone() : "" %>" />
    ...
    %>
        ...
        <input class="custom-input" type="number" name="quantity_<%= book.getId() %>" min="0" max="<%= book.getStock() %>" value="0"/>
    <%
            }
        }
    %>
...
<div class="bill-result">
    ...
    <h4 class="mt-3"><strong>Total Bill:</strong> $<%= String.format("%.2f", totalBill) %></h4>
</div>
</div>
<%
    }
